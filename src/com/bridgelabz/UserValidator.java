...
public class UserValidator {
    ...
    public String validFirstName(String userFirstName) throws UserRegistrationException {
        try {
            ...
            ValidationInterface fNameValidate = (fName) -> {
                String s = pattern.matcher(fName).matches() ? "Happy:User Entry Validated Successfully" : "Sad:User Entry Validation Failed";
                return s;
            };
